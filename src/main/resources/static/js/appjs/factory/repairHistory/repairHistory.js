var prefix = "/factory/repairHistory";
$(function () {
    loadType();
    load();
});
...
function load() {
    // $("#searchDateBefore").datetimepicker({
    //     format: 'yyyy-mm-dd',
    //     minView:'month',
    //     language: 'zh-CN',
    //     autoclose:true,
    //     startDate:new Date()
    // }).on("click",function(){
    //     $("#searchDateBefore").datetimepicker("setEndDate",$("#searchDateLater").val())
    // });
    // $("#searchDateLater").datetimepicker({
    //     format: 'yyyy-mm-dd',
    //     minView:'month',
    //     language: 'zh-CN',
    //     autoclose:true,
    //     startDate:new Date()
    // }).on("click",function(){
    //     $("#searchDateLater").datetimepicker("setStartDate",$("#searchDateBefore".val()))
    // });
    $('#exampleTable')
        .bootstrapTable(
            {
