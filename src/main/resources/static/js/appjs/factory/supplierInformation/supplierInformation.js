...
function loadCustermerType() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#custernameType").append(html);
            $("#custernameType").chosen({
                maxHeight: 200
            });
            //$(".chosen-select").val($("#Ttype").val());
            $("#custernameType").trigger("chosen:updated");
            // 点击事件
								...
								},
								{
                                   visible:false,
									...
									formatter : function(value, row, index) {
										...
										var f = '<a class="btn btn-success btn-sm '+s_person_h+'" href="#" title="联系人"  mce_href="#" onclick="person(\''
												+ row.custermerId
...
function reLoad() {//搜索（带参刷新）
    ...
    opt = {
        query: {
            custermerType: $('#custernameType').val(),
