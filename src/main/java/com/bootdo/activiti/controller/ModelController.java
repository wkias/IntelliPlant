...
public class ModelController extends BaseController {
    ...
    public R deploy(@PathVariable("id") String id,String flowType,Integer[] deptIds) throws Exception {
        if (Constant.DEMO_ACCOUNT.equals(getUsername())) {
            return R.error(1, "演示系统不允许修改,完整体验请部署程序");
        }
        //获取模型
        ...
        FlowConfigDO flowConfig=new FlowConfigDO(null,deptIds.length==0?0:deptIds[0],flowType,procdef.getId());
    ...
    public ModelAndView configModel(){
        ModelAndView mav=new ModelAndView();
        mav.setViewName("act/model/modelConfig");
        return mav;
    }
}
